        ...
        <div class="us">
            ...
            <% try{
               ...
               String password=request.getParameter("pw");
                ...
                String sql="select phonenumber,place,Email_id from student_regd where phonenumber='"+phone+"' and password='"+password+"'";
            ...
            <tr bgcolor="grey">
                ...
                <tr>
                    ...
                    <button style="background-color: yellow"> <a href="update_student1.html" style="text-decoration: none;">UPDATE</a></button>
