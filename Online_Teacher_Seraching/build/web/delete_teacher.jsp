<%-- 
    Document   : delete_teacher
    Created on : 23 Jul, 2023, 1:11:13 PM
    Author     : tapas
--%>
...
<html>
    ...
    <body>
            ...
            try{
                ...
                ResultSet rs=st.executeQuery("select phonenumber,password from teacher_regd where phonenumber='"+phone+"' and password='"+password+"'");
                if(rs.next()){
                    PreparedStatement ps=con.prepareStatement("delete from teacher_regd where phonenumber=?");
