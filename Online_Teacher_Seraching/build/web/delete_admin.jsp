...
<html>
    ...
    <body>
            ...
            try{
                ...
                ResultSet rs=st.executeQuery("select phonenumber,password from admin_regd where phonenumber='"+phone+"' and password='"+password+"'");
                if(rs.next()){
                    PreparedStatement ps=con.prepareStatement("delete from admin_regd where phonenumber=?");
